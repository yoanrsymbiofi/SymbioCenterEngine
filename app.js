...
function sendSignalTest() {
    ...
    rr = rrGenTab[_i];
    _i++;
    console.log("ymouster@symbiofi.com send: " + rr);
    for (var i in userSockets["ymouster@symbiofi.com"])
        if (sio.sockets.connected[userSockets["ymouster@symbiofi.com"][i]] != undefined)
            sio.sockets.connected[userSockets["ymouster@symbiofi.com"][i]].emit('rr', rr);
